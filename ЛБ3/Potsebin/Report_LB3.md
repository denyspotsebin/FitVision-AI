...
Звіт покриття коду перша спроба

![Звіт покриття коду друга спроба, досягнення 98% покритя](SecondTest.jpg)
Звіт покриття коду друга спроба, досягнення 98% покритя
## 6. Висновки
